...
using Fluxstrap.Models.APIs;

namespace Fluxstrap.Models.Entities
{
    public class ActivityData
    {
        ...
        public async Task<string?> QueryServerCountryCode()
        {
            const string LOG_IDENT = "ActivityData::QueryServerCountryCode";
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"Failed to get server country for {MachineAddress}");
                App.Logger.WriteException(LOG_IDENT, ex);
                return null;
            }
        }
