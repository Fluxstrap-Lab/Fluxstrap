...
using Fluxstrap.UI.Elements.About;
using Fluxstrap.UI.Elements.ContextMenu;

namespace Fluxstrap.UI
{
    public class NotifyIconWrapper : IDisposable
    {
        ...
        public NotifyIconWrapper(Watcher watcher)
        {
            ...
            {
                Icon = Properties.Resources.IconFluxstrap,
        ...
        {
            if ((App.Settings.Prop.DNDDuringGameplay && _watcher?.ActivityWatcher?.InGame == true) || App.Settings.Prop.StreamingMode)
            {
                App.Logger.WriteLine("NotifyIconWrapper::ShowAlert", "Suppressing alert (DND or Streaming Mode)");
                return;
            }
