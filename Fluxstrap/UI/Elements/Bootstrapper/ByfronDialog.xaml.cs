...
using Fluxstrap.UI.ViewModels.Bootstrapper;
...
namespace Fluxstrap.UI.Elements.Bootstrapper
{
    ...
    public partial class ByfronDialog : IBootstrapperDialog
    {
        ...
        public Fluxstrap.Bootstrapper? Bootstrapper { get; set; }
        ...
        public ByfronDialog()
        {
            ...
            if (App.Settings.Prop.Theme.GetFinal() == Theme.Light)
            {
                ...
                _viewModel.ByfronLogoLocation = LoadLogoSafe();
            }

            InitializeComponent();
        }
        private static ImageSource LoadLogoSafe()
        {
            try
            {
                return new BitmapImage(new Uri("pack://application:,,,/Resources/BootstrapperStyles/ByfronDialog/ByfronLogoLight.jpg"));
            }
            catch (Exception ex)
            {
                App.Logger.WriteException("ByfronDialog::LoadLogoSafe", ex);
                return App.Settings.Prop.BootstrapperIcon.GetIcon().GetImageSource()!;
            }
        }
