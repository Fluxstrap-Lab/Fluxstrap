...
using Fluxstrap.UI.Utility;

namespace Fluxstrap.UI.Elements.Dialogs
{
    ...
    public partial class FluentMessageBox
    {
        ...
        public FluentMessageBox(string message, MessageBoxImage image, MessageBoxButton buttons)
        {
            ...
            if (iconFilename is null)
                ...
                IconImage.Source = TryLoadImage(new Uri($"pack://application:,,,/Resources/MessageBox/{iconFilename}.png"));
        ...
        private static ImageSource? TryLoadImage(Uri uri)
        {
            ...
            {
                App.Logger.WriteException("FluentMessageBox::TryLoadImage", ex);
                return null;
            }
        }
