...
using Fluxstrap.Models.FluxstrapRPC;
...
namespace Fluxstrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Fluxstrap-QA";
#else
        public const string ProjectName = "Fluxstrap";
#endif
        public const string ProjectOwner = "Fluxstrap";
        public const string ProjectRepository = "bloxstraplabs/Fluxstrap";
        public const string ProjectDownloadLink = "https://bloxstraplabs.com";
        public const string ProjectHelpLink = "https://bloxstraplabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/bloxstraplabs/Fluxstrap/issues/new";
        ...
        public static FluxstrapRPCState RPCState { get; set; } = new();
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructFluxstrapWebUrl();
        ...
        public static string ConstructFluxstrapWebUrl()
        {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            else
            {
                ...
                // Apply software render mode is handled by app.manifest settings

                // Start memory trim timer
                TrimTimer();

                PlayTimeTracker.Load();

                UI.Elements.Base.WpfUiWindow.ApplyThemeResources();
