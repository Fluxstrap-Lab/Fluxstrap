namespace Fluxstrap
{
    static class Paths
    {
        ...
        public static string RobloxCache => Path.Combine(LocalAppData, "Roblox");
        public static string RobloxHttpCache => Path.Combine(RobloxCache, "http_cache");
        public static string RobloxCrashLogs => Path.Combine(RobloxLogs, "crash");
