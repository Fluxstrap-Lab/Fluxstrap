...
namespace Fluxstrap.Extensions
{
    static class BootstrapperIconEx
    {
        ...
        {
            BootstrapperIcon.IconFluxstrap,
            ...
            BootstrapperIcon.IconFluxstrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconFluxstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconFluxstrap => Properties.Resources.IconFluxstrap,
                ...
                BootstrapperIcon.IconFluxstrapClassic => Properties.Resources.IconFluxstrapClassic,
                _ => Properties.Resources.IconFluxstrap
            };
        }
    }
}
